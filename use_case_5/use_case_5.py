...
# Script to generate point cloud obtained through triangulation with non-systematic error (camera noise)
if __name__ == "__main__":
    ...
    for frame in sorted(os.listdir("../velodyne_1")):
        ...
        if frame in os.listdir("../velodyne_5/"):
            continue
        ...
        for point in content:
            ...
            triangulated_point = get_triangulated_point(
                point, P1, P2, P1, P2, noise_values=noise_values, noise=True
            )
        ...
        with open(f"../velodyne_5/{frame}", "wb") as rpc:
